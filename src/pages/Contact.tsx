...
const contactInfo = [
  {
    icon: MapPin,
    label: "Office",
    value: "Jl. Terusan Gn. Batu Istana, Pasteur Regency CRB No. 62, Cicendo, Kota Bandung",
  },
  ...
  return (
    <>
      <PageHeader
        title={
          <>
            <span className="text-gradient-brand">Feel free</span> to get in
            touch
          </>
        }
        description="An online web base platform for crafting 3D interactive content easily. Let's collaborate to identify the ideal strategies and learning frameworks tailored to your organization."
      />

      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-5 pb-20 sm:px-8 lg:grid-cols-2">
        {/* Info column */}
        <Reveal>
          ...
          <div className="border-border/60 bg-card/40 relative overflow-hidden rounded-2xl border p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-5" noValidate>
              ...
              <div className="flex items-start gap-2.5">
                ...
                />
                <Label htmlFor="agree" className="text-muted-foreground font-normal">
      ...
      <section className="mx-auto max-w-3xl px-5 pb-20 sm:px-8">
        <Reveal>
          <Accordion type="single" collapsible defaultValue="item-0" className="border-border/60 bg-card/40 rounded-2xl border px-6">
            {faqs.map((faq, i) => (
